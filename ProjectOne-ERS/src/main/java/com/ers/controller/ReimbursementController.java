...
import com.ers.service.ReimbursementServiceImp;
...
public class ReimbursementController {
	...
	public static void getAllTickets(Context context) {
		//used the context.json to set the response which will be returned to the user.
	...
	public static void createTicket(Context context) {
		int reimAmount = Integer.parseInt(context.formParam("reimAmount"));
		//form parameter by name, as string but then its parsed to an int value 
	...
	public static void updateTicket(Context context) {
		int reimId = Integer.parseInt(context.formParam("reimId")); 
		//form parameter by name, as string, but then its parsed to an int value 
		int reimStatusId = Integer.parseInt(context.formParam("reimStatusId")); 
		//form parameter by name, as string, but then its parsed to an int value 
